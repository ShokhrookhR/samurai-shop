...
exports.getProductsRoutes = void 0;
...
const getProductsRoutes = () => {
    ...
    const productsService = new productService_1.ProductService();
    productsRouter
        .get('/', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const allProducts = yield productsService.findProducts(req.query.title);
    ...
    middlewares_1.inputValidationMiddleware, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
        const createdProduct = yield productsService.createProduct(req.body.title);
        if (!createdProduct) {
            res.sendStatus(400);
            return;
        }
...
exports.getProductsRoutes = getProductsRoutes;
